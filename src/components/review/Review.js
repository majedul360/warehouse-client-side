          ...
          <SwiperSlide className="slider">
            <div className="slide">
              ...
              <p>
                ...
                such a variety of produce. Wandering through this store will
                make you think twice about eating out all the time and make use
                of your grill.
              </p>
            </div>
          </SwiperSlide>
          <SwiperSlide className="slider">
            ...
            <div className="slide">
              ...
              <p>
                ...
                fish, produce and coffees – more or less what you might find in
                a traditional European market. You won’t find many frozen
                options or huge choices of plastic bags, but a well-stocked Food
                Lion in the same shopping center supplies mundane needs.
              </p>
            </div>
          </SwiperSlide>
        </Swiper>
